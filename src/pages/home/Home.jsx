...
import { selectUserTickets, selectUserTicketsByStatus } from '../../reducers/ticketsReducer'
...
const Home = () => {
    ...
    const totals = {
        ...
        completed: allUserTickets.filter(t => t.status === "Completed").length
    };
                ...
                <div className="flex-wrapper">
                    ...
                    <div className="table-wrapper">
                        ...
                        <div className="home-mui-table-container">
                            <TicketsTable tickets={status === "All" ? allUserTickets : tickets} />
                        </div>
                    </div>
                </div>
